                        ...
                        datasets: [
                            ...
                            },
                            {
                                ...
                                data: this.categories.map((category) => {
                                    ...
                                    const budgetAmount = this.budget[0][category]; // assuming only one budget object
        ...
        async getTransactions() {
            try {
                ...
                if (userDocSnap.exists()) {
                    ...
                    const budgets = userDocSnap.data().Budgets;
                    console.log(budgets)
                    this.budget = budgets.filter((budget) => {
                        const seconds = budget.Date.seconds;
                        const nanoseconds = budget.Date.nanoseconds;
                        const budgetDate = new Date(seconds * 1000 + nanoseconds / 1e6);
