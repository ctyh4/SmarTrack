import "./chunk-CH4WIMQC.js";
<<<<<<< HEAD
import "./chunk-PZUBAXK2.js";
=======
import "./chunk-7P2CJLT7.js";
import "./chunk-G32NB65T.js";
>>>>>>> ea8362240f0c4b18ca37fee5e397c7c0140efda6
import {
  firebase
} from "./chunk-JK3EEG24.js";
import "./chunk-G32NB65T.js";
import "./chunk-GV5CQKMS.js";
import {
  __commonJS,
  __toESM
...
(function() {
  (function() {
    ...
    vb.prototype.toString = function() {
      ...
      var c = this.h;
      if (c || "file" == b)
        a.push("//"), (b = this.A) && a.push(Cb(b, Db, true), "@"), a.push(encodeURIComponent(String(c)).replace(
          /%25([0-9a-fA-F]{2})/g,
          "%$1"
    ...
    function ne(a, b, c, d, e, f) {
      ...
      if (a.addEventListener)
        Xd || (e = g), void 0 === e && (e = false), a.addEventListener(b.toString(), d, e);
    ...
    function se(a, b, c, d, e) {
      if (qa(b))
        ...
        (d = ta(d) ? !!d.capture : !!d, c = me(c), a && a[ae]) ? (a = a.J, b = String(b).toString(), b in a.a && (f = a.a[b], c = fe(f, c, d, e), -1 < c && (de(f[c]), Oa(f, c), 0 == f.length && (delete a.a[b], a.g--)))) : a && (a = oe(a)) && (b = a.a[b.toString()], a = -1, b && (a = fe(b, c, d, e)), (c = -1 < a ? b[a] : null) && te(c));
    }
    function te(a) {
    ...
    function Zh(a, b) {
      for (var c = 0; c < a.length; c++)
        if (!Ma($h, a[c]) && (null !== ai && a[c] in ai || Ma(b, a[c])))
          return a[c];
      return null;
    }
    ...
    function Fi(a) {
      if (Di(a)) {
        ...
        if (e)
          ...
          if ("/" != f.charAt(0) && (d.h && !d.g ? f = "/" + f : (d = c.g.lastIndexOf("/"), -1 != d && (f = c.g.substr(0, d + 1) + f))), ".." == f || "." == f)
            f = "";
    ...
    function Zi(a) {
      if (48 <= a && 57 >= a || 96 <= a && 106 >= a || 65 <= a && 90 >= a || (ec || bc) && 0 == a)
        return true;
      switch (a) {
        case 32:
        case 43:
    ...
    oj.prototype.handleEvent = function(a) {
      if ("input" == a.type)
        z && mc(10) && 0 == a.keyCode && 0 == a.j || (pj(this), xe(this, qj(a)));
    ...
    l.Jb = function(a) {
      if (ec || bc) {
        if (17 == this.R && !a.ctrlKey || 18 == this.R && !a.altKey || gc && 91 == this.R && !a.metaKey)
          this.X = this.R = -1;
      }
      ...
      function e(g) {
        if (!g.name || "cancel" != g.name) {
          ...
          if (p)
            ...
            p = g && g.message || "";
            if (g.code) {
              if ("auth/email-already-in-use" == g.code || "auth/credential-already-in-use" == g.code)
                return;
              p = T(g);
            }
            b.a(p);
          ...
          if (!h.name || "cancel" != h.name) {
            if (!h || "auth/credential-already-in-use" != h.code)
              if (h && "auth/email-already-in-use" == h.code && h.email && h.credential) {
                ...
                h && "auth/admin-restricted-operation" == h.code && pi(W(a)) ? (h = Q(b), b.m(), L("handleUnauthorizedUser", a, h, null, firebase.auth.GoogleAuthProvider.PROVIDER_ID)) : (h = T(h), b.a(h));
          }
        });
        V(a, f);
    ...
    K.callback = function(a, b, c) {
      ...
      V(a, c.then(function(e) {
        ...
        if ((e = Kl(e)) && ("auth/account-exists-with-different-credential" == e.code || "auth/email-already-in-use" == e.code) && e.email && e.credential)
          ...
          e && "auth/credential-already-in-use" == e.code || (e && "auth/operation-not-supported-in-this-environment" == e.code && Xl(a) ? gm(a, d, { user: null, credential: null }) : e && "auth/admin-restricted-operation" == e.code && pi(W(a)) ? (d.m(), Ah(X(a)), L("handleUnauthorizedUser", a, b, null, null)) : km(a, d, e));
      }));
    };
    function nm(a, b) {
    ...
    function Cn(a, b) {
      ...
      if (a = a.emulatorConfig)
        c = a.port, this.h.useEmulator(a.protocol + "://" + a.host + (null === c ? "" : ":" + c), a.options);
      Fn(this.h);
    ...
    l.ac = function(a) {
      ...
      return Gn(this, function(c) {
        return c ? c.linkWithCredential(a).then(function(d) {
          ...
          if (d && "auth/email-already-in-use" == d.code && d.email && d.credential)
            throw d;
          return Hn(b, d, a);
      ...
      return Gn(this, function(d) {
        return d ? d.linkWithPhoneNumber(a, b).then(function(e) {
          return new Sf(e, function(f) {
            if ("auth/credential-already-in-use" == f.code)
              return Hn(c, f);
            throw f;
          });
